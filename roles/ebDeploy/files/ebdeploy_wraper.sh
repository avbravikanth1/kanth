#!/bin/bash
 cd /opt/test_app | eb init -i --region ap-southeast-1 --platform "arn:aws:elasticbeanstalk:ap-southeast-1::platform/Node.js 16 running on 64bit Amazon Linux 2/5.5.4" eb_test | eb deploy # | eb use Ebtest-env 
