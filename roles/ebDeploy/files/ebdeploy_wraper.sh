...
cd /opt/test_app && eb init --profile eb-cli --region ap-southeast-1 --platform "arn:aws:elasticbeanstalk:ap-southeast-1:236894363456:application/eb_test with Node.js 16 running on 64bit Amazon Linux 2/5.5.4" Ebtest-env -v
